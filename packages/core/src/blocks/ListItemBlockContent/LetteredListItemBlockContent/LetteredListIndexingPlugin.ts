...
const PLUGIN_KEY = new PluginKey(`lettered-list-indexing`);
export const LetteredListIndexingPlugin = () => {
    return new Plugin({
        key: PLUGIN_KEY,
        appendTransaction: (_transactions, _oldState, newState) => {
            const tr = newState.tr;
            tr.setMeta("letteredListIndexing", true);
            ...
            newState.doc.descendants((node, pos) => {
                if (
                    ...
                    node.firstChild!.type.name === "letteredListItem"
                ) {
                    ...
                    if (prevBlock) {
                        ...
                        const isPrevBlockOrderedListItem =
                            prevBlockInfo.blockNoteType === "letteredListItem";
                    ...
                    const isFirst =
                        prevBlock?.firstChild?.type.name !== "letteredListItem";
